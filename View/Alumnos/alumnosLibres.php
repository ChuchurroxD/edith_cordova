...
<head>
	...
	<script src="../js/alumnosLibres.js"></script>	
</head>
	<body class="no-skin" >
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Todos Incritos en Cursos Libres
								</small>
							</h1>
						</div><!-- /.page-header -->
						<br>	
									...
									<table id="example" class="table table-striped table-bordered">
										<thead>											
								            <tr>
								                ...
								                <th rowspan="2" style="text-align: center; font-size: 11px; height: 10px; width: 8%;">Dni</th>
								                ...
								                <th colspan="2" style="text-align: center; font-size: 11px; height: 10px; width: 10%;">Cursos Libres</th>
								                <th rowspan="2" style="text-align: center; font-size: 11px; height: 10px; width: 10%;">Estado</th>
								                <th rowspan="2" style="text-align: center; font-size: 11px; height: 10px; width: 10%;">Operaciones</th>	
								            </tr>
								            <tr>								            	
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 5%;">Auto Maquillaje</th>
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 5%;">Peinados</th>
								            </tr>
