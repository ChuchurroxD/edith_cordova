...
<head>
	...
	<script src="../js/alumnosEgresados.js"></script>	
</head>
	<body class="no-skin" >
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="#">Cursos Para Alumnos Recien Egresados</a>
							</li>
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Todos Incritos en Cursos para Egresados
								</small>
							</h1>
						</div><!-- /.page-header -->
						<br>	
							...
							<div class="col-md-12">
								...
								<div>
									<table id="example" class="table table-striped table-bordered">
										<thead>											
								            <tr>
								            	<th style="text-align: center; font-size: 11px; height: 10px; width: 4%;">N°</th>
								                ...
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 8%;">Telefono</th>
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 14%;">Email</th>
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 10%;">F. Inscripción</th>
